...
const DELAY_MS = Number.parseInt(envConfig.DELAY_MS || "250", 10);
const NEW_MATCH_DELAY_MIN_MS = 2000;
const NEW_MATCH_DELAY_MAX_MS = 3000;
const DEFAULT_MATCH_DURATION_MINUTES = Number.parseInt(
    envConfig.SEED_MATCH_DURATION_MINUTES || "120",
    10,
);
const FORCE_LIVE =
    envConfig.SEED_FORCE_LIVE !== "0" &&
    envConfig.SEED_FORCE_LIVE !== "false";
